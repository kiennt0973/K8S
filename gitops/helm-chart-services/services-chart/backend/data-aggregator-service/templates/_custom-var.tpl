{{- define "data-aggregator-service.pvc-name" -}}
{{ default "default" (include "data-aggregator-service.fullname" .) }}
{{- end -}}


{{- define "data-aggregator-service.ingress-annotations" -}}
{{- $k8s_service_name := include "data-aggregator-service.fullname" . -}}
{{- $namespace := include "data-aggregator-service.namespace" . -}}
