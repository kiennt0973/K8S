{{- define "email-service.pvc-name" -}}
{{ default "default" (include "email-service.fullname" .) }}
{{- end -}}


{{- define "email-service.ingress-annotations" -}}
{{- $k8s_service_name := include "email-service.fullname" . -}}
{{- $namespace := include "email-service.namespace" . -}}
