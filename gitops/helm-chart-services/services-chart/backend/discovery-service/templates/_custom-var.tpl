{{- define "discovery-service.pvc-name" -}}
{{ default "default" (include "discovery-service.fullname" .) }}
{{- end -}}


{{- define "discovery-service.ingress-annotations" -}}
{{- $k8s_service_name := include "discovery-service.fullname" . -}}
