{{- define "ip-marketplace.pvc-name" -}}
{{ default "default" (include "ip-marketplace.fullname" .) }}
{{- end -}}


{{- define "ip-marketplace.ingress-annotations" -}}
{{- $k8s_service_name := include "ip-marketplace.fullname" . -}}
{{- $namespace := include "ip-marketplace.namespace" . -}}
