{{- define "ip-marketplace-admin.pvc-name" -}}
{{ default "default" (include "ip-marketplace-admin.fullname" .) }}
{{- end -}}


{{- define "ip-marketplace-admin.ingress-annotations" -}}
{{- $k8s_service_name := include "ip-marketplace-admin.fullname" . -}}
{{- $namespace := include "ip-marketplace-admin.namespace" . -}}
