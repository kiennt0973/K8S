{{- define "fe-test.pvc-name" -}}
{{ default "default" (include "fe-test.fullname" .) }}
{{- end -}}


{{- define "fe-test.ingress-annotations" -}}
{{- $k8s_service_name := include "fe-test.fullname" . -}}
{{- $namespace := include "fe-test.namespace" . -}}
