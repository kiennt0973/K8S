{{- define "ip-marketplace-mangement.pvc-name" -}}
{{ default "default" (include "ip-marketplace-mangement.fullname" .) }}
{{- end -}}


{{- define "ip-marketplace-mangement.ingress-annotations" -}}
{{- $k8s_service_name := include "ip-marketplace-mangement.fullname" . -}}
{{- $namespace := include "ip-marketplace-mangement.namespace" . -}}
